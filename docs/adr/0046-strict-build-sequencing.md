...
- Local developers testing builds must explicitly route their invocations via `./build.sh` rather than executing bare `cargo leptos build` to guarantee compilation consistency.
